<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_BGD_BJ_HX1.aspx.cs" Inherits="WebCheckProject.ZHHeader_BGD_BJ_HX1" %>
     ...
     <script type="text/javascript">  
         ...
         var hot = new Handsontable(document.getElementById("grid"), {
             ...
             nestedHeaders: [
                 ...
                 [
                     // 前5列留空
                     '室内<br>编号', '取样<br>位置','气温', '水温', '颜色', '气味', '透明度', // 物理性质5列
       ...
       function sendData() {
           ...
           xhr.open("POST", "ZHHeader_BGD_BJ_HX1.aspx?method=ReceiveJsonData", true);
