<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_BGD_BJ_TG5.aspx.cs" Inherits="WebCheckProject.ZHHeader_BGD_BJ_TG5" %>
                    ...
                    <p align="center" class="MsoNormal">
                        &nbsp;&nbsp;&nbsp; <b style="mso-bidi-font-weight: normal">
                            <span style="font-family: 宋体; mso-ansi-font-weight: bold; font-size: 20.0000pt; mso-font-kerning: 0.0000pt;">
                                <font face="宋体">击实后压缩渗透性质试验成果汇总表</font><o:p></o:p></span></b>
                    </p>
                        </td>
                                            <td nowrap
                            style="padding: 0.0000pt 5.4000pt 0.0000pt 5.4000pt; border-left: none; mso-border-left-alt: none; border-right: none; mso-border-right-alt: none; border-top: none; mso-border-top-alt: none; border-bottom: none; mso-border-bottom-alt: none;"
 ...
 <tr>
    ...
    <script type="text/javascript">  
        ...
        var hot = new Handsontable(document.getElementById("grid"), {
            ...
            nestedHeaders: [
                //第一行表头
                [{ label: "样品编号", colspan: 2 }, '取样深度', { label: "制样参数", colspan: 2 }, '压缩系数', '压缩模量', '压缩系数', '压缩模量', '压缩系数', '压缩模量', '压缩系数', '压缩模量', '压缩系数',
                    '压缩模量', '压缩系数', '压缩模量', { label: "渗透系数", colspan: 2 }],
                //第二行表头
                ['', '', '', '制样干密度', '制样含水率', '', '', '', '', '', '', '', '', '', '', '', '', '垂直', '水平'],
                //第三行表头
                ['野外', '室内', '', '', '', 'av0.5-1', 'Es0.5-1', 'av1-2', 'Es1-2', 'av2-4', 'Es2-4', 'av4-8', 'Es4-8', 'av8-12', 'Es8-12', 'av12-16', 'Es12-16', { label: "k20", colspan: 2 }],
                //第四行表头
                ['', '', 'm', 'g/cm³', '%', 'MPa-1', 'MPa', 'MPa-1', 'MPa', 'MPa-1', 'MPa', 'MPa-1', 'MPa', 'MPa-1', 'MPa', 'MPa-1', 'MPa', { label: "cm/s", colspan: 2 }],
            ],
            columns: [
       ...
       function sendData() {
           ...
           xhr.open("POST", "ZHHeader_BGD_BJ_TG5.aspx?method=ReceiveJsonData", true);
