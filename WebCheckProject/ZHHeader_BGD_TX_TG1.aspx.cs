...
namespace WebCheckProject
{
    ...
    public partial class ZHHeader_BGD_TX_TG1 : System.Web.UI.Page
    {
        ...
        //            Label1.Text = rp_no;
        //            //获取工程名称
        //            //string gcmc = Request.QueryString["gcmc"];
        //            string gcmc = gcmcget();
        //            Label2.Text = gcmc;
        //            //获取当前时间
            ...
            using (StreamReader reader = new StreamReader(Request.InputStream))
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    foreach (var row in dataArray)
                    {
                        ...
                        string checkSql = @"SELECT COUNT(*) FROM Report_list_tg01 WHERE YWno = @YWno AND SNno = @SNno";
