<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_BGD_TX_TG9.aspx.cs" Inherits="WebCheckProject.ZHHeader_BGD_TX_TG9" %>
                    ...
                    <p align="center" class="MsoNormal">
                        &nbsp;&nbsp;&nbsp; <b style="mso-bidi-font-weight: normal">
                            <span style="font-family: 宋体; mso-ansi-font-weight: bold; font-size: 20.0000pt; mso-font-kerning: 0.0000pt;">
                                <font face="宋体">土的分散性试验报告</font><o:p></o:p></span></b>
                    </p>
                        </td>
                                            <td nowrap
                            style="padding: 0.0000pt 5.4000pt 0.0000pt 5.4000pt; border-left: none; mso-border-left-alt: none; border-right: none; mso-border-right-alt: none; border-top: none; mso-border-top-alt: none; border-bottom: none; mso-border-bottom-alt: none;"
        ...
        <font
            ...
            <tr style="height: 29.2500pt;">
                <td colspan="4" nowrap
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; font-size: 11.0000pt; mso-font-kerning: 0.0000pt;">
                            <font face="宋体">备注：1.执行标准SL251-2015；2.报告结果仅适用于客户提供的样品；3.如对报告有异议，请于收到报告之日起十五日内向本单位提出，逾期不予受理。</font><o:p></o:p></span>
                    </p>
                </td>
    ...
    <script type="text/javascript">  
        ...
        var hot = new Handsontable(document.getElementById("grid"), {
            ...
            nestedHeaders: [
                ...
                ['室内', '野外', '不加分散剂时小于5μm颗粒含量', '加分散剂时小于5μm颗粒含量', '分散度D', '类别'],
                ['', '', '%', '%', '%', ''],
            ],
            columns: [
                    ...
                    if (col === 0) {
                       ...
                       // const trCols4 = trs[3].getElementsByTagName('th') // 获取第四行所有列
                        ...
                        if (trCols1.length === trCols2.length && trCols2.length === trCols3.length) {
                            ...
                            trCols2[5].style.borderBottom = 'none'
                            trCols1[5].style.borderBottom = 'none'
                            //全部居中
                            for (let i = 0; i < 6; i++) {
        ...
        function sendData() {
            ...
            xhr.open("POST", "ZHHeader_BGD_TX_TG9.aspx?method=ReceiveJsonData", true);
