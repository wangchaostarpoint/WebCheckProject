<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_BGD_TX_YS2.aspx.cs" Inherits="WebCheckProject.ZHHeader_BGD_TX_YS2" %>
                    ...
                    <p align="center" class="MsoNormal">
                        &nbsp;&nbsp;&nbsp; <b style="mso-bidi-font-weight: normal">
                            <span style="font-family: 宋体; mso-ansi-font-weight: bold; font-size: 20.0000pt; mso-font-kerning: 0.0000pt;">
                                <font face="宋体">岩石物理力学性质试验成果汇总表</font><o:p></o:p></span></b>
                    </p>
                        </td>
                                            <td nowrap
                            style="padding: 0.0000pt 5.4000pt 0.0000pt 5.4000pt; border-left: none; mso-border-left-alt: none; border-right: none; mso-border-right-alt: none; border-top: none; mso-border-top-alt: none; border-bottom: none; mso-border-bottom-alt: none;"
 ...
 <tr>
        ...
        <font
            ...
            <tr style="height: 29.2500pt;">
                <td colspan="4" nowrap
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; font-size: 11.0000pt; mso-font-kerning: 0.0000pt;">
                            <font face="宋体">备注：1.执行标准SL/T 264-2020、SL/T 352-2020； 2.报告结果仅适用于客户提供的样品；3.其他与测试有关的说明（制样参数、破坏类型、异常值的可知说明等）；4.如对报告有异议，请于收到报告之日起15日内向本单位提出，逾期不予受理。</font><o:p></o:p></span>
                    </p>
                </td>
    ...
    <script type="text/javascript">  
        ...
        var hot = new Handsontable(document.getElementById("grid"), {
            ...
            nestedHeaders: [
                ['', '', '', '颗粒密度', '干密度', '饱和密度', '吸水率', '饱和<br>吸水率', '饱水系数', '孔隙率', '', '干燥单轴<br>抗压强度', '饱和单轴<br>抗压强度', '软化系数', '冻融后饱和<br>单轴抗压强度<br>（25次）', '冻融系数', '冻融质量<br>损失率', '硫化物<br>和硫酸<br>盐总含量'],
                ['野外编号', '室内编号', '岩石名称', 'ρ<sub>p</sub>', 'ρ<sub>d</sub>', 'ρ<sub>s</sub>', 'ω<sub>a</sub>', 'ω<sub>s</sub>', 'k<sub>w</sub>', 'n<sub>p</sub>', '压力与<br>层理关系', 'R<sub>d</sub>', 'R<sub>s</sub>', 'η', 'R<sub>f</sub>', 'K<sub>f</sub>', 'L<sub>f</sub>', 'Q<sub>s</sub>'],
                ['', '', '', {label: "g/cm<sup>3</sup>",colspan: 3}, '%', '%', '-', '%', '', 'MP<sub>a</sub>', 'MP<sub>a</sub>', '-', 'MP<sub>a</sub>', '-', '%', '%', '%'],
            ],
            columns: [
         ...
         afterGetColHeader: function (col, th) {
                setTimeout(() => {
                    if (col === 0) {
                        ...
                        trCols2[10].style.borderBottom = 'none'
                        trCols2[10].style.verticalAlign = 'middle'
                        for (let i = 0; i < 19; i++) {
        ...
        function sendData() {
            ...
            xhr.open("POST", "ZHHeader_BGD_TX_YS2.aspx?method=ReceiveJsonData", true);
