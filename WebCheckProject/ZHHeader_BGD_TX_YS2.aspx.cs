...
namespace WebCheckProject
{
    ...
    public partial class ZHHeader_BGD_TX_YS2 : System.Web.UI.Page
    {
        //方法重构
        ...
        protected string gcmcget()
        {
            ...
            string sqlstr = "select gcmc from commission_sheet_ys2 where cno= @NO";
            ...
            using (StreamReader reader = new StreamReader(Request.InputStream))
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    foreach (var row in dataArray)
                    {
                        ...
                        string checkSql = @"SELECT COUNT(*) FROM Report_list_ys2 WHERE YWno = @YWno AND SNno = @SNno";
