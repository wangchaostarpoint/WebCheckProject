...
namespace WebCheckProject
{
    ...
    public partial class ZHHeader_WTD_Fill_Others_TX_CLT : System.Web.UI.Page
    {
            ...
            using (StreamReader reader = new StreamReader(Request.InputStream))
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    foreach (var row in dataArray)
                    {
                        ...
                        string checkSql = @"SELECT COUNT(*) FROM commission_sheet_clt2 WHERE  SNno = @SNno";
                ...
                dataTable.Columns.Add("yuliu", typeof(string));                
                ...
                DB dB = new DB();
                DateTime rq = DateTime.Today;
                dB.task_custom(NO1, rq, "已派发", "徐青青", "");//如果插入成功，a是true
                dB.task_ry(NO1, " ");
                Context.Response.ContentType = "application/json";
