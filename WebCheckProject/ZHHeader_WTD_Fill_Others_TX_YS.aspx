...
mso-border-bottom-alt:none;" valign="center" width="985">
    ...
    <script type="text/javascript">  
        ...
        var hot = new Handsontable(document.getElementById("grid"), {
            ...
            nestedHeaders: [
                ['', '野外<br>编号', '岩石<br>名称', '取样<br>位置', '取样深<br>度(m)', '风化<br>程度', '样品<br>数量', '比重', '干密<br>度', '饱和<br>密度', '吸水<br>率', '饱和吸<br>水率', '饱水<br>系数', '显孔<br>隙率', '压力与层<br>理关系',
                    {
                        label: "单轴抗压强度试验",
                        colspan: 3
                    }, {
                        ...
                        label: "直剪强度试验",
                        colspan: 2
                    }, '硫酸盐及硫<br>化物含量', '抗拉<br>强度', '点荷<br>载强度',],
                ['室内<br>编号', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '干燥单轴<br>抗压强度', '饱和单轴<br>抗压强度', '软化<br>系数', '冻融后饱和单<br>轴抗压强度', '冻融<br>系数', '冻融质量<br>损失率', '试样含<br>水状态', '变形<br>模量', '泊桑比', '抗剪断', '抗剪', '', '', ''],
                ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
            ],
            columns: [
