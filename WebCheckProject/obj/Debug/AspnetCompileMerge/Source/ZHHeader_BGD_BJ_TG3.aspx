<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_BGD_BJ_TG3.aspx.cs" Inherits="WebCheckProject.ZHHeader_BGD_BJ_TG3" %>
                    ...
                    <p align="center" class="MsoNormal">
                        &nbsp;&nbsp;&nbsp; <b style="mso-bidi-font-weight: normal">
                            <span style="font-family: 宋体; mso-ansi-font-weight: bold; font-size: 20.0000pt; mso-font-kerning: 0.0000pt;">
                                <font face="宋体">剪力试验成果汇总表</font><o:p></o:p></span></b>
                    </p>
                        </td>
                                            <td nowrap
                            style="padding: 0.0000pt 5.4000pt 0.0000pt 5.4000pt; border-left: none; mso-border-left-alt: none; border-right: none; mso-border-right-alt: none; border-top: none; mso-border-top-alt: none; border-bottom: none; mso-border-bottom-alt: none;"
  ...
  <script type="text/javascript">  
      ...
      var hot = new Handsontable(document.getElementById("grid"), {
          ...
          nestedHeaders: [
              //第一行表头
              [{
                  label: "样品编号", colspan: 2}, { label: "原状快剪", colspan: 6 }, { label: "饱和快剪", colspan: 6 }],
              //第二行表头
              ['', '', { label: "不同垂直压力下的剪应力τ", colspan: 4 }, '凝聚力', '内摩擦角', { label: "不同垂直压力下的剪应力τ", colspan: 4 }, '凝聚力', '内摩擦角'],
              //第三行表头
              ['野外', '室内', '100', '200', '300', '400', 'c', 'φ', '100', '200', '300', '400', 'c', 'φ'],
              //第四行表头
              ['', '', { label: "kPa", colspan: 4 }, 'kPa', '度', { label: "kPa", colspan: 4 }, 'kPa', '度'],
          ],
          columns: [
       ...
       function sendData() {
           ...
           xhr.open("POST", "ZHHeader_BGD_BJ_TG3.aspx?method=ReceiveJsonData", true);
