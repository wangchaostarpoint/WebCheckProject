<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_BGD_BJ_YS1.aspx.cs" Inherits="WebCheckProject.ZHHeader_BGD_BJ_YS1" %>
 ...
 <tr>
    ...
    <script type="text/javascript">  
        ...
        var hot = new Handsontable(document.getElementById("grid"), {
            ...
            nestedHeaders: [
                //重定义表头
                [{ label: "编号", colspan: 2 }, '岩石名称', '颗粒密度', '干密度', '饱和密度', '吸水率', '饱和吸水率', '饱和系数', '孔隙率', '压力与</br>层理关系', '干燥单轴抗压强度', '饱和单轴抗压强度', '软化系数', '饱和变形模量', '饱和泊桑比',
                { label: "抗剪断强度", colspan: 2 }, { label: "抗剪强度", colspan: 2 }],
                ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '摩擦系数', '凝聚力', '摩擦系数', '凝聚力'],
                ['野外', '室内', '', 'ρ<sub>p</sub>', 'ρ<sub>d</sub>', 'ρ<sub>s</sub>', 'ω<sub>a</sub>', 'ω<sub>s</sub>', 'k<sub>w</sub>', 'n<sub>p</sub>', '', 'R<sub>d</sub>', 'R<sub>s</sub>', 'η', 'E<sub>50</sub>', 'μ<sub>50</sub>', 'f’', 'c’', 'f', 'c'],
                ['', '', '', { label: "g/cm<sup>3</sup>", colspan: 3 }, '%', '%', '-', '%', '', 'MPa', 'MPa', '-', 'GPa', '-', '-', 'MPa', '-', 'MPa'],
            ],
            columns: [
            ...
            afterGetColHeader: function (col, th) {
                setTimeout(() => {
                    if (col === 0) {
                        ...
                        trCols4[2].style.display = 'none';

                        trCols1[10].rowSpan = 4;
                        trCols2[10].style.display = 'none';
                        trCols3[10].style.display = 'none';
                        trCols4[10].style.display = 'none';
       ...
       function sendData() {
           ...
           xhr.open("POST", "ZHHeader_BGD_BJ_YS1.aspx?method=ReceiveJsonData", true);
