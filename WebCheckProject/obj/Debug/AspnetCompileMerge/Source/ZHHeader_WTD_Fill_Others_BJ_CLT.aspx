<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_WTD_Fill_Others_BJ_CLT.aspx.cs" Inherits="WebCheckProject.ZHHeader_WTD_Fill_Others_BJ_CLT" %>
        ...
        <p align="center" class="MsoNormal" style="text-align: center;">
            <b style="mso-bidi-font-weight: normal">
                <span style="font-family: 宋体; mso-ansi-font-weight: bold; font-size: 20.0000pt; mso-font-kerning: 0.0000pt;">
                    <font face="宋体">粗粒土试验项目委托单 </font><o:p></o:p>
                </span>
            </b>
        </p>
    </td>
...
mso-border-bottom-alt:none;" valign="center" width="985">
    ...
    <script type="text/javascript">  
       ...
       function sendData() {
           ...
           xhr.open("POST", "ZHHeader_WTD_Fill_Others_BJ_CLT.aspx?method=ReceiveJsonData", true);
