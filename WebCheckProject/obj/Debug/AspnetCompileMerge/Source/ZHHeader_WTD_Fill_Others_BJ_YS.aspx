<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_WTD_Fill_Others_BJ_YS.aspx.cs" Inherits="WebCheckProject.ZHHeader_WTD_Fill_Others_BJ_YS" %>
...
mso-hansi-font-family:Calibri;mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;
mso-font-kerning:1.0000pt;"><font face="Calibri">C/30</font></span></td>
            </tr>
       </table>
            <br />
             <div id="grid"></div>
...
mso-border-bottom-alt:none;" valign="center" width="985">
    ...
    <script type="text/javascript">  
       ...
       function sendData() {
           ...
           xhr.open("POST", "ZHHeader_WTD_Fill_Others_BJ_YS.aspx?method=ReceiveJsonData", true);
