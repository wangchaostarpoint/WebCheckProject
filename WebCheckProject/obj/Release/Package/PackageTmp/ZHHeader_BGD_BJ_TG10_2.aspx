<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_BGD_BJ_TG10_2.aspx.cs" Inherits="WebCheckProject.ZHHeader_BGD_BJ_TG10_2" %>
     ...
     <script type="text/javascript">  
         ...
         var hot = new Handsontable(document.getElementById("grid"), {
             ...
             nestedHeaders: [
                 ...
                 }, '表观', '堆积密度', '松散堆积<br>空隙率', '吸水率', '含泥量', '泥块<br>含量', '针、片状<br>颗粒含量', { label: "软弱颗粒含量", colspan: 3 },
                     '有机质含量', '硫化物和硫酸盐<br>总含量<br>(SO₃)', '粒度模数', '压碎值', '坚固性<br>(总质量损失率)'],
                 //表头第二行
                 ['野外编号', '室内编号', '密度', '', '', '', '', '', '', '40/20', '20/10', '10/5', '', '', '', '', ''],
                 //表头第三行
       ...
       function sendData() {
           ...
           xhr.open("POST", "ZHHeader_BGD_BJ_TG10_2.aspx?method=ReceiveJsonData", true);
