<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_BGD_BJ_TG2.aspx.cs" Inherits="WebCheckProject.ZHHeader_BGD_BJ_TG2" %>
                    ...
                    <p align="center" class="MsoNormal">
                        &nbsp;&nbsp;&nbsp; <b style="mso-bidi-font-weight: normal">
                            <span style="font-family: 宋体; mso-ansi-font-weight: bold; font-size: 20.0000pt; mso-font-kerning: 0.0000pt;">
                                <font face="宋体">颗分试验成果汇总表</font><o:p></o:p></span></b>
                    </p>
                        </td>
                                            <td nowrap
                            style="padding: 0.0000pt 5.4000pt 0.0000pt 5.4000pt; border-left: none; mso-border-left-alt: none; border-right: none; mso-border-right-alt: none; border-top: none; mso-border-top-alt: none; border-bottom: none; mso-border-bottom-alt: none;"
 ...
 <tr>
    ...
    <script type="text/javascript">  
        ...
        var hot = new Handsontable(document.getElementById("grid"), {
            ...
            nestedHeaders: [
                ...
                [
                    ...
                    { label: '土粒组成', colspan: 8 },
                    { label: '土类代号', colspan: 1 },
                    { label: '土按规范定名', colspan: 1 }
                ],
                // 第二行表头
                [
                    '', '', { label: "土的粒径（mm）", colspan: 4 }, '有效粒径 d10', '限制粒径 d60', '不均匀系数 Cu', '曲率系数 Cc', '', ''
                ],
                // 第三行表头
                [
                    '野外', '室内', '砾粒', '砂粒', '粉粒', '粘粒', '', '', '', '', '', ''
            ...
            columns: [
                ...
                { type: 'text', readOnly: false }, // 土的粒径 - 砾粒
                { type: 'text', readOnly: false }, // 土的粒径 - 砂粒
                { type: 'text', readOnly: false }, // 土的粒径 - 粉粒
                { type: 'text', readOnly: false }, // 土的粒径 - 粘粒
                { type: 'numeric', readOnly: false }, // 有效粒径 d10
                { type: 'numeric', readOnly: false }, // 限制粒径 d60
                { type: 'numeric', readOnly: false }, // 不均匀系数 Cu
                { type: 'numeric', readOnly: false }, // 曲率系数 Cc
                { type: 'text', readOnly: false }, // 土类代号
                { type: 'text', readOnly: false }  // 土按规范定名
            ],
                ...
                setTimeout(() => {
                    if (col === 0) {
                        ...
                        for (let i = 0; i <= 1; i++) {
                            ...
                            trCols4[i].style.borderBottom = 'none';
                            trCols3[i].style.verticalAlign = 'bottom';
                        }
       ...
       function sendData() {
           ...
           xhr.open("POST", "ZHHeader_BGD_BJ_TG2.aspx?method=ReceiveJsonData", true);
