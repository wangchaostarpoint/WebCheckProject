<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_BGD_TX_HX2.aspx.cs" Inherits="WebCheckProject.ZHHeader_BGD_TX_HX2" %>
                    ...
                    <p align="center" class="MsoNormal">
                        &nbsp;&nbsp;&nbsp; <b style="mso-bidi-font-weight: normal">
                            <span style="font-family: 宋体; mso-ansi-font-weight: bold; font-size: 20.0000pt; mso-font-kerning: 0.0000pt;">
                                <font face="宋体">土壤腐蚀性分析报告</font><o:p></o:p></span></b>
                    </p>
                        </td>
                                            <td nowrap
                            style="padding: 0.0000pt 5.4000pt 0.0000pt 5.4000pt; border-left: none; mso-border-left-alt: none; border-right: none; mso-border-right-alt: none; border-top: none; mso-border-top-alt: none; border-bottom: none; mso-border-bottom-alt: none;"
 ...
 <tr>
        ...
        <font
            ...
            <tr style="height: 29.2500pt;">
                <td colspan="4" nowrap
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; font-size: 11.0000pt; mso-font-kerning: 0.0000pt;">
                            <font face="宋体">备注：1. 执行标准：GB/T 50123-2019；2.报告结果仅适用于客户提供的样品；3.如对报告有异议，请于收到报告之日起十五日内向本单位提出，逾期不予受理。</font><o:p></o:p></span>
                    </p>
                </td>
    ...
    <script type="text/javascript">  
        ...
        var hot = new Handsontable(document.getElementById("grid"), {
            ...
            nestedHeaders: [
                ['室内编号', '野外编号', '取样位置', '取样深度', 'pH值', 'Ca<sup>2+</sup>', 'Mg<sup>2+</sup>', 'Cl<sup>-</sup>', 'SO<sub>4</sub><sup>2-</sup>', 'HCO<sub>3</sub><sup>-</sup>', 'CO<sub>3</sub><sup>2-</sup>'],
                ['m', '—', 'g/kg', 'g/kg', 'g/kg', 'g/kg', 'g/kg', 'g/kg'],
            ],
       ...
       function sendData() {
           ...
           xhr.open("POST", "ZHHeader_BGD_TX_HX2.aspx?method=ReceiveJsonData", true);
