<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_BGD_TX_TG7.aspx.cs" Inherits="WebCheckProject.ZHHeader_BGD_TX_TG7" %>
                    ...
                    <p align="center" class="MsoNormal">
                        &nbsp;&nbsp;&nbsp; <b style="mso-bidi-font-weight: normal">
                            <span style="font-family: 宋体; mso-ansi-font-weight: bold; font-size: 20.0000pt; mso-font-kerning: 0.0000pt;">
                                <font face="宋体">土的颗分试验成果汇总表</font><o:p></o:p></span></b>
                    </p>
                        </td>
                                            <td nowrap
                            style="padding: 0.0000pt 5.4000pt 0.0000pt 5.4000pt; border-left: none; mso-border-left-alt: none; border-right: none; mso-border-right-alt: none; border-top: none; mso-border-top-alt: none; border-bottom: none; mso-border-bottom-alt: none;"
 ...
 <tr>
        ...
        <font
            ...
            <tr style="height: 29.2500pt;">
                <td colspan="4" nowrap
                    ...
                    <p class="MsoNormal">
                        <span style="font-family: 宋体; font-size: 11.0000pt; mso-font-kerning: 0.0000pt;">
                            <font face="宋体">备注：1.执行标准GB/T50123-2019；  2.报告结果仅适用于客户提供的样品；  3.如对报告有异议，请于收到报告之日起十五日内向本单位单位提出，逾期不予受理。</font><o:p></o:p></span>
                    </p>
                </td>
    ...
    <script type="text/javascript">  
            ...
            nestedHeaders: [
                ...
                ['野外', '室内', {
                    ...
                    colspan: 2
                        ...
                        label: "细粒",
                        colspan: 2
                    }, '有效粒径', '限制粒径', '不均匀系数', '曲率系数', '土类代号', '土的名称', '最大干密度', '最小干密度'],
                ['', '', '＞200', '200/60', '60/40', '40/20', '20/10', '10/5', '5/2', '2/1', '1/0.5', '0.5/0.25', '0.25/0.075', '0.075/0.005', '<0.005', 'd10', 'd60', 'Cu', 'Cc', '', '', 'ρdmax', 'ρdmin'],
                ['', '', '%', '%', '%', '%', '%', '%', '%', '%', '%', '%', '%', '%', '%', 'mm', 'mm', '--', '--', '', '', 'g/cm<sup>3</sup>', 'g/cm<sup>3</sup>']
            ],
            columns: [
         ...
         afterGetColHeader: function (col, th) {
                setTimeout(() => {
                    if (col === 0) {
                        ...
                        const trCols5 = trs[4].getElementsByTagName('th') // 获取第五行所有列
                        console.log(trCols3)
                        if (trCols1.length === trCols2.length && trCols2.length === trCols3.length && trCols3.length === trCols4.length) {
                            ...
                            trCols4[0].style.borderBottom = 'none'
                           
                            //隐藏第二列二三四行底线
                            trCols2[1].style.borderBottom = 'none'
                            trCols3[1].style.borderBottom = 'none'
                            trCols4[1].style.borderBottom = 'none'
                            
                            //隐藏第16、17、18、19、20列二三行底线
                            for (let i = 15; i < 23; i++) {
                                trCols2[i].style.borderBottom = 'none'
                                trCols3[i].style.borderBottom = 'none'
                            }
                            //隐藏第20、21列一行底线
                            trCols1[19].style.borderBottom = 'none'
                            trCols1[20].style.borderBottom = 'none'
                            trCols4[19].style.borderBottom = 'none'
                            trCols4[20].style.borderBottom = 'none'
                            //居中格式修改
                            for (let i = 0; i < 23; i++) {
                            ...
                            for (let i = 2; i < 23; i++) {
                                trCols5[i].style.verticalAlign = 'middle'
                            }
                         //   将第四行16-22列置顶
                            for (let i = 15; i < 23; i++) {
                                
                                trCols4[i].style.verticalAlign = 'top'
                            }

                            //将偶数行标题尽量对齐 位置放偶数行底
                            trCols3[0].style.verticalAlign = 'bottom'
                            trCols3[1].style.verticalAlign = 'bottom'
                            trCols2[19].style.verticalAlign = 'bottom'
                            trCols2[20].style.verticalAlign = 'bottom'
                            ...
                            //}
                            ///*合并第11列
                            //trCols1[10].rowSpan = 4
                            //trCols1[10].style.verticalAlign = 'middle'
                            //trCols1[10].style.height = '64px'
                            //trCols2[10].className = 'hiddenHeader'
                            //trCols3[10].className = 'hiddenHeader'
                            //trCols4[10].className = 'hiddenHeader'
                            //trCols1[10].style.borderBottom = 'none'
                            //合并其他列*/
                            //for (let i = 3; i < 10; i++) {
                            //    // 如果单元格不包含colSpan属性且不是隐藏的单元格，则表明需要合并行，否则，则表明不需要合并行
                            //    if (!trCols1[i].getAttribute('colSpan') && trCols1[i].className !== 'hiddenHeader') {
        ...
        function sendData() {
            ...
            xhr.open("POST", "ZHHeader_BGD_TX_TG7.aspx?method=ReceiveJsonData", true);
