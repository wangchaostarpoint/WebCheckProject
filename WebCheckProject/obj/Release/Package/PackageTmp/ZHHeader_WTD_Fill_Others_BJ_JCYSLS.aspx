<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_WTD_Fill_Others_BJ_JCYSLS.aspx.cs" Inherits="WebCheckProject.ZHHeader_WTD_Fill_Others_BJ_JCYSLS" %>
...
mso-hansi-font-family:Calibri;mso-bidi-font-family:Calibri;color:rgb(0,0,0);
font-size:9.0000pt;mso-font-kerning:1.0000pt;"><font face="Calibri">-4</font></span><span style="mso-spacerun:'yes';font-family:Calibri;mso-fareast-font-family:宋体;
...
mso-border-bottom-alt:none;" valign="center" width="985">
    ...
    <script type="text/javascript">  
        ...
        var hot = new Handsontable(document.getElementById("grid"), {
            ...
            nestedHeaders: [
                ['', '野外<br>编号', '取土<br>地址', '样品<br>数量', '取土<br>深度<br>（m）',
                    {
                        label: "砂",
                        colspan: 13
                    }, {
                ...
                ['室内<br>编号', '', '', '', '', '砂颗<br>分', '砂表观<br>密度', '砂堆积<br>密度', '砂孔<br>隙率', '砂吸<br>水率', '砂含<br>泥量', '砂粘<br>土块<br>含量', '砂云母<br>含量', '砂轻<br>物质<br>含量', '砂有<br>机质', '砂水<br>溶盐<br>含量', '砂硫<br>化物', '砂坚<br>固性', '颗分', '表观<br>密度', '堆积<br>密度', '孔隙<br>率', '吸水<br>率', '含泥<br>量', '粘土块<br>含量', '针片状<br>含量', '软弱<br>颗粒<br>含量', '轻物质<br>含量', '有机<br>质', '硫化<br>物', '坚固<br>性', '压碎<br>指标'],
                ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
            ],
            columns: [
       ...
       function sendData() {
           ...
           xhr.open("POST", "ZHHeader_WTD_Fill_Others_BJ_JCYSLS.aspx?method=ReceiveJsonData", true);
