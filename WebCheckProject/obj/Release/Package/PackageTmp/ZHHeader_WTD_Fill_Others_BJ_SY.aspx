<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_WTD_Fill_Others_BJ_SY.aspx.cs" Inherits="WebCheckProject.ZHHeader_WTD_Fill_Others_BJ_SY" %>
...
mso-border-bottom-alt:none;" valign="center" width="985">
    ...
    <script type="text/javascript">  
        ...
        var hot = new Handsontable(document.getElementById("grid"), {
            ...
            nestedHeaders: [
                ['室内编号', '野外编号', '取水地址', '水源类型', '取水深度（m）', '分析目的',
                    {
                        label: "阳离子",
                        colspan: 3
                    }, {
                ...
                ['', '', '', '', '', '', 'K<sup>+</sup>+Na<sup>+</sup>', 'Ca<sup>2+</sup>', 'Mg<sup>2+</sup>', 'Cl<sup>-</sup>', 'SO<sub>4</sub><sup>2-</sup>', 'HCO<sub>3</sub><sup>-</sup>', 'CO<sub>3</sub><sup>2-</sup>', ''],
                ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
            ],
            columns: [
       ...
       function sendData() {
           ...
           xhr.open("POST", "ZHHeader_WTD_Fill_Others_BJ_SY.aspx?method=ReceiveJsonData", true);
