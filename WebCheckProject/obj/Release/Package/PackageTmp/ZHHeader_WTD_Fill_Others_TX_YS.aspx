<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHHeader_WTD_Fill_Others_TX_YS.aspx.cs" Inherits="WebCheckProject.ZHHeader_WTD_Fill_Others_TX_YS" %>
        ...
        <p align="center" class="MsoNormal" style="text-align: center;">
            <b style="mso-bidi-font-weight: normal">
                <span style="font-family: 宋体; mso-ansi-font-weight: bold; font-size: 20.0000pt; mso-font-kerning: 0.0000pt;">
                    <font face="宋体">岩石物理力学性质试验委托单</font><o:p></o:p>
                </span>
            </b>
        </p>
    </td>
...
mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;mso-font-kerning:1.0000pt;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ZLJL</span><span style="mso-spacerun:'yes';font-family:宋体;mso-ascii-font-family:Calibri;
...
mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;mso-font-kerning:1.0000pt;">11-04</span><span style="mso-spacerun:'yes';font-family:宋体;mso-ascii-font-family:Calibri;
mso-hansi-font-family:Calibri;mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;
...
mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;mso-font-kerning:1.0000pt;">-202</span><span style="mso-spacerun:'yes';font-family:宋体;mso-ascii-font-family:Calibri;
mso-hansi-font-family:Calibri;mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;
mso-font-kerning:1.0000pt;"><font face="Calibri">3</font></span><span style="mso-spacerun:'yes';font-family:Calibri;mso-fareast-font-family:宋体;
...
mso-hansi-font-family:Calibri;mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;
mso-font-kerning:1.0000pt;"><font face="Calibri">C/30</font></span><b style="mso-bidi-font-weight:normal"><span style="mso-spacerun:'yes';font-family:Calibri;mso-fareast-font-family:宋体;
mso-bidi-font-family:'Times New Roman';mso-ansi-font-weight:bold;font-size:10.5000pt;
...
mso-border-bottom-alt:none;" valign="center" width="985">
                                <p class="MsoNormal">
                                    <span style="font-family:宋体;color:rgb(0,0,0);font-size:10.0000pt;
mso-font-kerning:0.0000pt;"><font face="宋体">工程编号：</font></span><span style="font-family:宋体;color:rgb(0,0,0);font-size:10.0000pt;
mso-font-kerning:0.0000pt;"><font face="宋体"><asp:TextBox ID="TextBoxg" runat="server" CssClass="CurledLineMiddle"></asp:TextBox>
                                    </font></span></p>
                            </td>
                        </tr>
...
mso-border-bottom-alt:none;" valign="center" width="985">
    ...
    <script type="text/javascript">  
        ...
        var hot = new Handsontable(document.getElementById("grid"), {
            ...
            nestedHeaders: [
                ['', '野外<br>编号', '岩石<br>名称', '取样<br>位置', '取样<br>深度<br>（m）', '风化<br>程度', '样品<br>数量', '比重', '干密<br>度', '饱和<br>密度', '吸水<br>率', '饱和<br>吸水<br>率', '饱水<br>系数', '显孔<br>隙率', '压力<br>与层<br>理关<br>系',
                    {
                        label: "单轴抗压强度试验",
                        colspan: 3
                    }, {
                        ...
                        label: "直剪强度试验",
                        colspan: 2
                    }, '硫酸盐<br>及硫化<br>物含量', '抗拉<br>强度', '点荷<br>载强度',],
                ['室内<br>编号', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '干燥单<br>轴抗压<br>强度', '饱和单<br>轴抗压<br>强度', '软化<br>系数', '冻融后饱<br>和单轴抗<br>压强度', '冻融<br>系数', '冻融质量<br>损失率', '试样含<br>水状态', '变形<br>模量', '泊桑比', '抗剪断', '抗剪', '', '', ''],
                ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
            ],
            columns: [
       ...
       function sendData() {
           ...
           var Gcbh = document.getElementById('TextBoxg').value;
           ...
           xhr.open("POST", "ZHHeader_WTD_Fill_Others_TX_YS.aspx?method=ReceiveJsonData", true);
